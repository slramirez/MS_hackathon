...
##### STEP 1:  
DONE CIRI data 1981-2011 = downloaded as is  
DONE CIRI data 1981-2018 = downloaded as is  
...
## NLP Libraries  
The spaCy project was used for natural language processing.  After building the conda environment, spacy needs to load the default english model:  
`$ python -m spacy download en_core_web_sm`

## US State Department Human Rights Report
File: us_state_dept_reports_1999_2018.csv.zip  
Size: 84 MB compressed, 278 MB uncompressed   
Source: Downloaded from US State Department using `scrape.py` method `state_dl_to_csv()`  
Alternative already downloaded: https://www.dropbox.com/s/cjb65h10gy2tyd0/us_state_dept_reports_1999_2018.csv.zip?dl=1  
URL: https://www.state.gov/j/drl/rls/hrrpt/  
Variables:
...
File: us_state_dept_hr_reports_un_coded_1999_2018.csv  
Size: 84 MB compressed, 278 MB uncompressed  
Source: labeled version of us_state_dept_reports_1999_2018.csv.zip using UN Code Mapping sources detailed below and `Apply UN Labels to US State Department Human Rights Records.ipynb`  
Variables:  Same as us_state_dept_reports_1999_2018.csv.zip with:
* code : UN Country Code

## UN Code Mapping  
File: state_dept_country_names.csv  
Source:
Variables:  
* index, not used
* country : str, State Department country name
* simple : str, Gapminder Project country name

File: UNCTRY_CODES_GapMinderNames.csv  
Source:  
Variables:
* CTRY : str, Gapminder Project country name
* UNCTRY : int, United Nations country code
Notes: 9000 used for UNCTRY where no UN country code existed, such as Taiwan

## Cingranelli-Richards (CIRI) Human Rights Data Project  
The CIRI data contains 15 indicators across 195 countries.  Until 2011, data was generated by Cingranelli, Richards and Clay published the reports, afterwards the CIRIGHTS Data Project at Binghamton University has generated it.  

### CIRI Data 1981-2011
File: CIRI Data 1981_2011 2014.04.14.csv  
Size:  461 KB  
Source:  CIRI Human Rights Data Project  
Citation: Cingranelli, David, Mikhail Filippov, and Skip Mark. 2018. The CIRIGHTS Dataset. Version 2018.02.18. The Binghamton University Human Right Institute, www.binghamton.edu/institutes/hri/  
URL: http://www.humanrightsdata.com/p/data-documentation.html  
Project Source:  Downloaded from source Google Drive and stored on Dropbox at:  
https://www.dropbox.com/s/7tmbttddeiaap94/CIRI%20Data%201981_2011%202014.04.14.csv?dl=1
Notes:  
* Variable names coincide with definitions below  

### CIRIGHTS Data 1981-2016  
File: ci_rights_data_project_dataset.csv  
Size:  489 KB  
Source: CIRIGHTS Data Project  
Citation: Cingranelli, David, David L. Richards, and K. Chad Clay. 2014. The CIRI Human Rights Dataset. Version 2014.04.14.  
URL: https://docs.google.com/document/d/1ZxuitRNKpTcEpwi_1p8u0IRnib7ggtKF9TQcf_jbmo0/edit  
Project Source: Downloaded from Google Drive and converted from .xlsx to .csv and hosted on Dropbox at:  
https://www.dropbox.com/s/x2sct3bsy63zb31/ci_rights_data_project_dataset.csv?dl=1  
Notes:  
* Variable names are lower case and not the same order as CIRI data

#### CIRI Data Format  
CIRIGHTS continues the data format and indicator categories first developed in CIRI.  The following variable definitions are applicable to both CIRI and CIRIGHTS sources.
